...
load('C:\Users\P.N.Vamshi\Desktop\BTP\EmotionAnalysis\src\tests\deap_features.mat')
ctr = 0;
for part = 1:32
    for trial = 1:40
        ...
        % "Continuous emotion detection in response to music videos." Automatic Face & Gesture Recognition and Workshops
        ...
        %translation of reported keywords to two levels of arousal and valence and likability
